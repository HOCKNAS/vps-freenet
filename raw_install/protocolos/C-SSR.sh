...
msg -bar
        stty erase '^H' && read -p "(Predeterminado: VPS-FREENET):" ssr_user
        [[ -z "${ssr_user}" ]] && ssr_user="VPS-FREENET"
...
msg -bar
        stty erase '^H' && read -p "(Predeterminado: VPS-FREENET):" ssr_password
        [[ -z "${ssr_password}" ]] && ssr_password="VPS-FREENET"
