...
clear
msg -bar
rm -rf /etc/vps-freenet/demo-ssh 2>/dev/null
mkdir /etc/vps-freenet/demo-ssh 2>/dev/null
...
rm -rf /tmp/cmd
touch /etc/vps-freenet/demo-ssh/$name
echo "senha: $pass" >> /etc/vps-freenet/demo-ssh/$name
echo "data: ($tmp)Minutos" >> /etc/vps-freenet/demo-ssh/$name
msg -bar2
echo -e "\033[1;93m ¡¡ USUARIO TEMPORAL x MINUTOS (VPS  ) !!\033[0m"
msg -bar2
