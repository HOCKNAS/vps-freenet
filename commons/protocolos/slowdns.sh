...
#by @rufu99
[[ ! -d /etc/vps-freenet ]] && exit
[[ ! -d /etc/vps-freenet/protocolos ]] && exit
ADM_inst="/etc/vps-freenet/Slow/install" && [[ ! -d ${ADM_inst} ]] && exit
ADM_slow="/etc/vps-freenet/Slow/Key" && [[ ! -d ${ADM_slow} ]] && exit
info(){
        clear
        nodata(){
                msg -bar
...
[[ -e ${ADM_slow}/domain_ns ]] && NS1=$(cat < ${ADM_slow}/domain_ns) || unset NS1 NS
  ...
  msg -bar        
    ...
    if [[ ! -e ${ADM_inst}/dns-server ]]; then
        ...
        if wget -O ${ADM_inst}/dns-server raw.github.com/HOCKNAS/vps-freenet/master/bin/dns-server &>/dev/null ; then
    ...
    msg -bar
    msg -ama "    INSTALANDO SERVICIO 𝙎𝙇𝙊𝙒𝘿𝙉𝙎   ..."
...
echo "[Unit]
Description=Slowdns by @vps-freenet
...
start_slow(){
        clear
        msg -bar
        msg -verd "    INICIANDO NUEVAMEMTE EL SERVICIO 𝙎𝙇𝙊𝙒𝘿𝙉𝙎...."
...
do
        ...
        echo -e "  $(msg -verd "[1]")$(msg -verm2 "➛ ")$(msg -azu "\e[1;92mINSTALAR 𝙎𝙇𝙊𝙒𝘿𝙉𝙎  ")"
        echo -e "  $(msg -verd "[2]")$(msg -verm2 "➛ ")$(msg -azu "\e[91mDETENER 𝙎𝙇𝙊𝙒𝘿𝙉𝙎  ")"
        echo -e "  $(msg -verd "[3]")$(msg -verm2 "➛ ")$(msg -azu "\e[1;92mINICIAR 𝙎𝙇𝙊𝙒𝘿𝙉𝙎  ")"
        echo -e "  $(msg -verd "[4]")$(msg -verm2 "➛ ")$(msg -azu "DATOS DE LA CUENTA")"
        echo -e "  $(msg -verd "[5]")$(msg -verm2 "➛ ")$(msg -azu "\e[1;91mDESINSTALAR 𝙎𝙇𝙊𝙒𝘿𝙉𝙎  ")"
