...
echo -e "\033[1;32m $(fun_trans  "              INSTALADOR SSL By VPS")"
msg -bar
...
msg -bar
 ...
 sleep 3  
 screen -dmS pydic-80 python ${SCPinst}/python.py 80 "VPS" && echo "80 VPS" >> /etc/vps-freenet/PySSL.log
 msg -bar
 } 
 install_ssl(){  
...
/etc/vps-freenet/protocolos/ssl.sh
;;
4)
exit
;;
