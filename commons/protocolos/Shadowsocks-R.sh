...
1)
msg -bar
wget --no-check-certificate -O shadowsocks-r.sh https://raw.githubusercontent.com/HOCKNAS/vps-freenet/master/functions/libs/shadowsocks-r.sh > /dev/null 2>&1
chmod +x shadowsocks-r.sh
./shadowsocks-r.sh 2>&1 
...
wget --no-check-certificate -O shadowsocks-r.sh https://raw.githubusercontent.com/HOCKNAS/vps-freenet/master/functions/libs/shadowsocks-r.sh > /dev/null 2>&1
chmod +x shadowsocks-r.sh
./shadowsocks-r.sh uninstall
rm -rf shadowsocks-r.sh
msg -bar
sleep 3
exit
;;
