...
1)
msg -bar
wget --no-check-certificate -O shadowsocks-libev.sh https://raw.githubusercontent.com/HOCKNAS/vps-freenet/master/functions/libs/shadowsocks-libev.sh > /dev/null 2>&1
